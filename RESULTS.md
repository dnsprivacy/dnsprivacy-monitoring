## dnsprivaycy.org monitoring results
Latest run at:  date
 See [https://github.com/dnsprivacy/dnsprivacy-monitoring/actions/workflows/dnsprivacy-monitoring.yml](the output of the latest workflow for more details)
...
| dot1.appliedprivacy.net  (v6) |  :x:  |  :x:  |  :x:  |  :white_check_mark:  |  :white_check_mark:  |  :white_check_mark:  |  :white_check_mark:  |  :white_check_mark:  |  :white_check_mark:  |  :white_check_mark:  |  :x:  |  :white_check_mark:  |  :x:  |
...
Latest run at:  Thu Aug 1 02:53:48 UTC 2024
